    ...
    <div className="space-y-6">
      ...
      {searchParams.status === "success" && (
        <div className="rounded-xl border border-emerald-400/30 bg-emerald-500/10 px-4 py-3 text-sm text-emerald-700 dark:text-emerald-200">
          <PartyPopper className="mr-1 inline h-4 w-4" aria-hidden="true" />You&apos;re on Pro! It may take a few seconds to reflect everywhere — refresh if needed.
        </div>
      )}
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <div className="mt-1 flex items-center gap-3">
              ...
              {pro ? <span className="badge-brand"><Star className="h-3 w-3 fill-current" aria-hidden="true" /> Pro</span> : <span className="badge">Free</span>}
            </div>

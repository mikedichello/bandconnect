  ...
  if (!token) {
    return (
      <div className="card w-full max-w-md p-6 text-center">
        <p className="text-zinc-200">This reset link is missing its token.</p>
  ...
  return (
    <div className="w-full max-w-md">
      <div className="mb-8 text-center">
        ...
        <p className="mt-2 text-sm text-zinc-400">Choose a strong password you don&apos;t use elsewhere.</p>
      </div>

      {done ? (
        <div className="card p-6 text-center">
          <div className="text-3xl">✅</div>
          <p className="mt-3 text-zinc-200">Password updated! Taking you to log in…</p>
        </div>
      ) : (
